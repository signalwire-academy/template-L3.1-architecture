# Lab 3.1: Enterprise Architecture
...
git commit -m "Complete Lab 3.1: Enterprise Architecture"
git push
```
...
Ready to continue? [**Start Lab 3.2: Knowledge & RAG**](https://classroom.github.com/a/wKDWimeO)
